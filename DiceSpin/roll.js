...
function change(current) {
  if (!current) {
    ...
    document.getElementById("dice_icon2").style.color = "#3498db";
    document.getElementById("dice_icon1").style.color = "#3498db";
  } else {
    ...
    document.getElementById("dice_icon2").style.color = "#e74c3c";
    document.getElementById("dice_icon1").style.color = "#e74c3c";
  }
}
